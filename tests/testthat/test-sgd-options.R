...
test_that("Gradients with use_matvec_via_transp=TRUE and use_cpp_matvec=TRUE coincide with gradients with use_matvec_via_transp=FALSE and use_cpp_matvec=TRUE for linear model", {
  expect_true(
...
test_that("Gradients with use_matvec_via_transp=TRUE and use_cpp_matvec=TRUE coincide with gradients with use_matvec_via_transp=TRUE and use_cpp_matvec=FALSE for logit model", {
  expect_true(
    compare_grad_between_options("logit", list(via_transp = TRUE, use_rcpp = TRUE), list(via_transp = TRUE, use_rcpp = FALSE))
  )
})

test_that("Gradients with use_matvec_via_transp=TRUE and use_cpp_matvec=TRUE coincide with gradients with use_matvec_via_transp=FALSE and use_cpp_matvec=TRUE for logit model", {
  expect_true(
    compare_grad_between_options("logit", list(via_transp = TRUE, use_rcpp = TRUE), list(via_transp = FALSE, use_rcpp = TRUE))
  )
})

test_that("Gradients with use_matvec_via_transp=TRUE and use_cpp_matvec=TRUE coincide with gradients with use_matvec_via_transp=FALSE and use_cpp_matvec=FALSE for logit model", {
  expect_true(
