...
calc_loglink_deriv <- function(model, reg_coef, order, subset_ind = NULL, via_transp, use_rcpp, ...) {
...
calc_loglink_deriv.linear_model <- function(model, reg_coef, order, noise_var = 1, subset_ind = NULL, via_transp, use_rcpp) {
...
calc_loglink_deriv.logit_model <- function(model, reg_coef, order, subset_ind = NULL, via_transp, use_rcpp) {
...
calc_grad <- function(model, reg_coef, subset_ind = NULL, via_transp, use_rcpp, ...) {
